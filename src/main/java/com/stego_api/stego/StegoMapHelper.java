        ...
        for (int r = 0; r < map.length; r++) {
            for (int c = 0; c < map[0].length; c++) {
                ...
                if (ok == false) {//if we are not in the middle of a section
                    ...
                    //if the next 2 map are the same, set ok to true and this pixel to 0
                        ...
                        if (map[r][c].intValue ( ) == map[r][c + 1].intValue ( )) {//test next pixel
                            if (map[r][c].intValue ( ) == map[r][c + 2].intValue ( )) {//test pixel after next
                                ...
                                //this will work because i can modify even map that are not the same value to be null
                            }
                        }
                    ...
                    if (min) {//if we are on the minimum, leave it as is and set min to false
                        min = false;
                    } else if (ok == true) {//if the section continues, we can begin putting text bytecode into the map
                        ...
                        if (str.equals ( "1" )) {
//                            p.editPix(r,c,map[r][c].intValue()+1);
                        }
